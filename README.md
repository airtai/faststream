...
“url”: “kafka.airt.ai”, “description”: “production kafka broker”,
“port”: 9092, “protocol”: “kafka-secure”, “security”: {“type”: “plain”},
}, }
...
async with asyncer.create_task_group() as tg:
    ...
    tg.soonify(run_script_and_cancel)(
        script=script, script_file="server.py", cmd="fastkafka run --num-workers=4 server:kafka_app", cancel_after=120
    )
