...
def get_model_schema(
    ...
    body: Optional[Dict[str, Any]] = model_schema(model)

    if params_number == 1 and not use_original_model:
        param_body: Dict[str, Any] = body.get("properties", {})  # type: ignore[union-attr]
    ...
    if not use_original_model:
        body["title"] = f"{prefix}:Payload"  # type: ignore[index]
