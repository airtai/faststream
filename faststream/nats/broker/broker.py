...
class NatsBroker(
    ...
    def __init__(
        ...
        *,
        ...
        dont_randomize: Annotated[
            bool,
            Doc("Boolean indicating should client randomly shuffle servers list for reconnection randomness.")
        ] = False,
        ...
        inbox_prefix: Annotated[
            Union[str, bytes],
            Doc("Prefix for generating unique inboxes, subjects with that prefix and NUID")
        ] = DEFAULT_INBOX_PREFIX,
    ...
    def subscriber(  # type: ignore[override]
        ...
        headers_only: Annotated[
            Optional[bool],
            Doc("Should be message delivered without payload, only headers and metadata.")
        ] = None,
        # pull arguments
        pull_sub: Annotated[
            Optional["PullSub"],
