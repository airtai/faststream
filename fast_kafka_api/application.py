...
# %% auto 0
__all__ = ['logger', 'FastKafkaAPI', 'to_json_utf8', 'produce_decorator', 'filter_using_signature', 'create_producer']
...
async def create_producer(
    *,
    ...
    Args:
        ...
        producer_list: A list of producers to add the new producer to.
