...
- Tutorial
    ...
    - [Observability](getting-started/observability/index.md)
        ...
        - [OpenTelemetry](getting-started/observability/opentelemetry/index.md)
            ...
            - [Spans](getting-started/observability/opentelemetry/spans.md)
            - [Spans Autocreationg](getting-started/observability/opentelemetry/faststream-flow.md)
            - [Baggage](getting-started/observability/opentelemetry/baggage.md)
            - [Metrics](getting-started/observability/opentelemetry/metrics.md)
            - [Another tools integration](getting-started/observability/opentelemetry/integration.md)
