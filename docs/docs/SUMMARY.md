...
- User Guide
    ...
    - Subscription and Serialization
        - [Intro](getting-started/subscription/index.md)
    ...
    - Publishing
        - [Intro](getting-started/publishing/index.md)
    ...
    - Dependencies
        - [Intro](getting-started/dependencies/index.md)
    ...
    - Context
        - [Intro](getting-started/context/index.md)
    ...
    - Custom Serialization
        - [Intro](getting-started/serialization/index.md)
    ...
    - Lifespan
        - [Intro](getting-started/lifespan/index.md)
...
- Integrations
    - [Intro](integrations/index.md)
    - [FastAPI](integrations/fastapi/index.md)
    - [HTTP Frameworks](integrations/frameworks/index.md)
- API
    - faststream
        - app
