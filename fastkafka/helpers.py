# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/009_Helpers.ipynb.
...
def create_missing_topics(
    ...
    *,
    ...
    replica_assignment: Optional[List[List[Any]]] = None,
    new_topic_config: Optional[Dict[str, str]] = None,
    **kwargs: Dict[str, Any],
) -> None:
    ...
    new_topics = [
        NewTopic(topic, config=new_topic_config if new_topic_config else {}, **kwargs)
    ...
    **kwargs: Dict[str, Any],
    ...
    try:
        ...
        def prepare_msg(msg: Any) -> bytes:
            """Prepare a message for sending over the network.
...
def get_collapsible_admonition(
    ...
    """Get a collapsible admonition.

    Args:
        code_block: The code block to be included in the admonition.
...
async def wait_for_get_url(
    ...
    """A function to wait for a url to be fetched.
    ...
    Raises:
        TimeoutError: If the url could not be fetched for more than timeout seconds
