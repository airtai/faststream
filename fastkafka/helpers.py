...
# %% ../nbs/999_Helpers.ipynb 5
if in_notebook():
    from tqdm.notebook import tqdm, trange
else:
    from tqdm import tqdm, trange

# %% ../nbs/999_Helpers.ipynb 7
logger = get_logger(__name__)

# %% ../nbs/999_Helpers.ipynb 10
