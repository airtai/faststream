...
# %% auto 0
__all__ = ['logger', 'KafkaRecord', 'KafkaPartition', 'KafkaTopic', 'create_consumer_record', 'ConsumerMetadata',
...
class KafkaPartition:
    ...
    def write(self, value: bytes, key: Optional[bytes] = None) -> KafkaRecord:
        record = KafkaRecord(
            topic=self.topic, partition=self.partition, value=value, key=key
        )
...
# %% ../../nbs/001_InMemoryBroker.ipynb 21
@dataclass
