  ...
  'syms': { 'fastkafka._application.app': { 'fastkafka._application.app.AwaitedMock': ( 'fastkafka.html#awaitedmock',
            ...
            'fastkafka._components.logger': { 'fastkafka._components.logger.get_default_logger_configuration': ( 'logger.html#get_default_logger_configuration',
                                              ...
                                              'fastkafka._components.logger.supress_timestamps': ( 'logger.html#supress_timestamps',
                                                                                                   'fastkafka/_components/logger.py')},
            'fastkafka._components.producer_decorator': { 'fastkafka._components.producer_decorator._to_json_utf8': ( 'producerdecorator.html#_to_json_utf8',
                                                                                                                      'fastkafka/_components/producer_decorator.py'),
                                                          'fastkafka._components.producer_decorator._wrap_in_message': ( 'producerdecorator.html#_wrap_in_message',
                                                                                                                         'fastkafka/_components/producer_decorator.py'),
