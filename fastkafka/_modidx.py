...
d = { 'settings': { 'branch': 'main',
  ...
  'syms': { 'fastkafka._application.app': { 'fastkafka._application.app.AwaitedMock': ( 'fastkafka.html#awaitedmock',
                                            ...
                                            'fastkafka._application.app.FastKafka.set_kafka_broker': ( 'fastkafka.html#fastkafka.set_kafka_broker',
                                                                                                       'fastkafka/_application/app.py'),
                                            'fastkafka._application.app.FastKafka.start': ( 'fastkafka.html#fastkafka.start',
                                                                                            'fastkafka/_application/app.py'),
                                            'fastkafka._application.app.FastKafka.stop': ( 'fastkafka.html#fastkafka.stop',
                                                                                           'fastkafka/_application/app.py'),
            ...
            'fastkafka._application.tester': { 'fastkafka._application.tester.Tester': ( 'tester.html#tester',
                                               ...
                                               'fastkafka._application.tester.Tester.create_mirrors': ( 'tester.html#tester.create_mirrors',
                                                                                                        'fastkafka/_application/tester.py'),
                                               'fastkafka._application.tester.Tester.start': ( 'tester.html#tester.start',
                                                                                               'fastkafka/_application/tester.py'),
                                               'fastkafka._application.tester.Tester.stop': ( 'tester.html#tester.stop',
                                                                                              'fastkafka/_application/tester.py'),
            ...
            'fastkafka._components.test_dependencies': { 'fastkafka._components.test_dependencies._install_java': ( 'test_dependencies.html#_install_java',
                                                         ...
                                                         'fastkafka._components.test_dependencies.generate_app_src': ( 'test_dependencies.html#generate_app_src',
                                                                                                                       'fastkafka/_components/test_dependencies.py')},
            'fastkafka._documentation.helpers': { 'fastkafka._documentation.helpers._run_example_app': ( 'guides/guides_helpers.html#_run_example_app',
                                                                                                         'fastkafka/_documentation/helpers.py')},
