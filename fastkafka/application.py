# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/000_FastKafka.ipynb.

# %% auto 0
__all__ = ['logger', 'FastKafka', 'produce_decorator', 'filter_using_signature', 'AwaitedMock', 'Tester', 'mirror_producer',
           'mirror_consumer']

# %% ../nbs/000_FastKafka.ipynb 1
import asyncio
import functools
import json
import tempfile
...
class FastKafka:
    ...
    def consumes(
        ...
        **kwargs: Dict[str, Any],
        ...
        Args:
            ...
            prefix: The prefix to use for the event name.
            kwargs: Additional keyword arguments to pass to the consumer.

        Returns:
            A callable that can be used to consume messages.

        Raises:
            NotImplementedError: If the consumer is not implemented.
    ...
    def produces(  # type: ignore
        ...
        **kwargs: Dict[str, Any],
        ...
        """Produces a callable that can be used to produce messages to a topic.

        Args:
            topic (Optional[str]): The topic to produce to.
            prefix (str): The prefix to use for the topic name.
            producer (Optional[AIOKafkaProducer]): The producer to use.
            kwargs (Dict[str, Any]): The keyword arguments to pass to the producer.

        Returns:
            ProduceCallable: The callable that can be used to produce messages.
    ...
    def _populate_consumers(
        ...
        Args:
            is_shutting_down_f: A function that returns True if the process is shutting down.
...
def consumes(
    ...
    **kwargs: Dict[str, Any],
    ...
    def _decorator(
        ...
        """Decorator to register a function as a consumer.

        Args:
            on_topic: The function to be registered as a consumer.
            topic: The topic to subscribe to.
            kwargs: Additional keyword arguments to pass to the consumer.

        Returns:
            The function to be registered as a consumer.
...
def produce_decorator(
    ...
    async def _produce_async(*args: List[Any], **kwargs: Dict[str, Any]) -> BaseModel:
        ...
        Returns:
            BaseModel: The return value of the function
    ...
    def _produce_sync(*args: List[Any], **kwargs: Dict[str, Any]) -> BaseModel:
        """Produce a message to a topic synchronously.
...
def produces(
    ...
    **kwargs: Dict[str, Any],
    ...
    def _decorator(
        ...
        """Decorator to add a producer to the producer store.

        Args:
            on_topic: The topic to produce on.
            topic: The topic to produce on.
            kwargs: The kwargs to pass to the producer.

        Returns:
            The produce_decorator.
...
async def _populate_bg_tasks(
    ...
    """A function to populate background tasks.

    Args:
        self: The FastKafka object
...
async def startup(self: FastKafka) -> None:
    ...
    def is_shutting_down_f(self: FastKafka = self) -> bool:
        """A function to check if the system is shutting down.
...
async def shutdown(self: FastKafka) -> None:
    """Shutdown the FastKafka instance.
...
def create_docs(self: FastKafka) -> None:
    """Create the docs for the FastKafka class.

    Args:
        self: The FastKafka class
...
class AwaitedMock:
    ...
    def __init__(self, o: Any):
        """Wrapper class for waiting for mock assertions to pass until timeout
...
class Tester(FastKafka):
    ...
    def __init__(self, app: Union[FastKafka, List[FastKafka]]):
        """
        Args:
            app: A FastKafka object or a list of FastKafka objects
...
def mirror_producer(topic: str, producer_f: Callable[..., Any]) -> Callable[..., Any]:
    ...
    Args:
        topic: The topic to mirror
        producer_f: The producer function
...
def mirror_consumer(topic: str, consumer_f: Callable[..., Any]) -> Callable[..., Any]:
    """Mirror a consumer function.

    Args:
        topic: The topic to mirror
        consumer_f: The consumer function

    Returns:
        A mirrored consumer function
