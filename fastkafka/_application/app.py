...
# %% ../../nbs/000_FastKafka.ipynb 21
FastKafka.__module__ = "fastkafka"

# %% ../../nbs/000_FastKafka.ipynb 26
@patch  # type: ignore
@delegates(AIOKafkaConsumer)  # type: ignore
def consumes(
    self: FastKafka,
