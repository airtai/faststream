...
def _create_safe_callback(
    ...
    async def _safe_callback(
        ...
        Raises:
            Exception: If an exception is raised while awaiting the callback function
...
def _decode_streamed_msgs(  # type: ignore
    ...
    """Decode messages from a Kafka stream.

    Args:
        msgs: A list of Kafka messages
        msg_type: The type of the messages
...
async def _aiokafka_consumer_loop(
    ...
    **kwargs,
    ...
    async def process_message_callback(
        ...
        """Process a message callback.

        Args:
            receive_stream: A memory object receive stream
            callback: A callback function
