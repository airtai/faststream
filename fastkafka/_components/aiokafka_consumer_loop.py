...
# %% auto 0
__all__ = ['logger', 'AsyncConsume', 'AsyncConsumeMeta', 'SyncConsume', 'SyncConsumeMeta', 'ConsumeCallable',
...
AsyncConsumeMeta = Callable[[BaseModel, Any], Awaitable[None]]
SyncConsume = Callable[[BaseModel], None]
SyncConsumeMeta = Callable[[BaseModel, Any], None]
...
def _callback_parameters_wrapper(
    ...
    async def _params_wrap(  # type: ignore
        ...
        args: List[Union[BaseModel, ConsumerRecord]] = [msg]  # type: ignore
