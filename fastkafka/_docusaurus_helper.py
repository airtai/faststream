...
def _fix_invalid_syntax_in_markdown(docs_path: str) -> None:
...
def _generate_markdown_docs(module_name: str, docs_path: str) -> None:
...
def docusaurus_dummy() -> None:
    pass


docusaurus_dummy.__module__ = "_dummy"
